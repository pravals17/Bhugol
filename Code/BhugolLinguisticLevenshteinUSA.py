# -*- coding: utf-8 -*-
"""
Linguistic pattern-based approach of geocoding (LEVENSHTEIN)
"""
...
def main():
    ...
    for suff in suffixes:
        ...
        df_cluster = pd.read_csv('/BhugolCode/Data/SuffixesHDBSCANClusters/USA/' + suff + 'cluster.csv')
            ...
            for ids in clusters:
                ...
                for place in places:
                    if place != groundtruth[i]:
                        similarity. append(fuzz.ratio(groundtruth[i], place))
